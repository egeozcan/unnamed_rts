...
const hydraPersonality: AIPersonality = {
    aggression_bias: 1.5,          // Very aggressive
    retreat_threshold: 0.15,       // Fight harder before retreating
    attack_threshold: 3,           // Attack with just 3 units - constant pressure
    ...
    unit_preferences: {
        infantry: ['rocket', 'grenadier', 'rifle'],
        vehicle: ['heavy', 'light', 'flame_tank']
    },
    harvester_ratio: 1.6,         // Lean eco - army wins games, not harvesters
    ...
    min_attack_group_size: 3,      // Small groups, more frequent attacks
...
export const hydraAIImplementation: AIImplementation = {
    id: 'hydra',
    name: 'Hydra',
